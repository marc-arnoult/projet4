                ...
                <div class="field is-horizontal">
                    <div class="field-body">
                        <div class="field">
                            ...
                            <p class="control is-expanded ">
                                <input v-model="ticket.birthday" class="input is-medium" type="date" name="birthday" @blur="calculatePrice" required>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="field is-horizontal">
                    <div class="field-body">
                        ...
                        <div class="field">
                            ...
                            <p class="control is-expanded">
                                <input v-model="ticket.reduction" class="checkbox" type="checkbox">
                                <span class="help">Ex: Militaire, Etudiant</span>
                            </p>
                        </div>
                    </div>
                </div>
